...
// NOTE: `_includes` and `_sass` are intentionally allowed on this personal-site
// fork — it carries site-specific overrides (custom navbar header, theme colour),
// which `docs/BOUNDARIES.md` permits. The thin-starter contract still guards the
// remaining core component paths.
